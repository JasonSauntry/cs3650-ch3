...
{
	int version = storage_get_inc_version(path, "mkdnod");
...
{
	int version = storage_get_inc_version(path, "mkdir");
...
{
	int version = storage_get_inc_version(path, "unlink");
...
{
	int version = storage_get_inc_version(to, "link");
...
{
	int version = storage_get_inc_version(path, "chmod");
...
{
	int version = storage_get_inc_version(path, "truncate");
...
{
	int version = storage_get_inc_version(path, "write");
...
{
	int version = storage_get_inc_version(path, "utimens");
...
int nufs_symlink(const char* to, const char* from) {
	int version = storage_get_inc_version(to, "symlink");
